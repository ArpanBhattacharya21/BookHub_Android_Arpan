...
import com.arpan.bookhub.adapter.DashboardRecyclerAdapter
import com.arpan.bookhub.model.Book
import com.arpan.bookhub.util.ConnectionManager
        ...
        if(ConnectionManager().checkConnectivity(activity as Context)){
            val jsonObjectRequest = object : JsonObjectRequest(Request.Method.GET, url, null, Response.Listener{
                ...
                override fun getHeaders(): MutableMap<String, String> {
                    ...
                    headers["Content-type"] = "application/json" //data we send and receive in JSON
            ...
            dialog.setMessage("Internet Connection Not Found! Please connect to Internet!")
